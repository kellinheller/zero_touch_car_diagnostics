...
/// Service to interact with qFlipper backend native code.
...
class FlipperService {
  ...
  static Future<List<String>> getDevices() async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.getDevices() error: $e');
      }
      return [];
    }
  }
  ...
  static Future<bool> connectDevice(String deviceId) async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.connectDevice() error: $e');
      }
      return false;
    }
  }
  ...
  static Future<void> disconnectDevice() async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.disconnectDevice() error: $e');
      }
    }
  }
  ...
  static Future<void> installFirmware(String filePath) async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.installFirmware() error: $e');
      }
      rethrow;
    }
  }
  ...
  static Future<Map<String, dynamic>?> getDeviceInfo() async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.getDeviceInfo() error: $e');
      }
      return null;
    }
  }
  ...
  static Future<void> factoryReset() async {
    try {
      ...
      if (kDebugMode) {
        print('FlipperService.factoryReset() error: $e');
      }
      rethrow;
    }
  }
