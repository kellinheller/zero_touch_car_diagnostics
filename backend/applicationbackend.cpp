...
#include "serialdevice/screenstreamer.h"
#include "serialdevice/virtualdisplay.h"
#include "serialdevice/filemanager.h"

#include "serialdevice/flipperzero.h"
#include "serialdevice/devicestate.h"
#include "serialdevice/assetmanifest.h"
#include "serialdevice/screenstreamer.h"

#include "serialdevice/helper/toplevelhelper.h"

#include "serialdevice/pixmaps/updateok.h"
#include "serialdevice/pixmaps/updating.h"
...
SerialDevice *ApplicationBackend::device() const
{
...
void ApplicationBackend::onCurrentDeviceChanged()
{
    ...
    if(m_backendState > BackendState::ScreenStreaming && m_backendState < BackendState::Finished) {
        ...
        connect(device(), &SerialDevice::operationFinished, this, &ApplicationBackend::onDeviceOperationFinished);
        connect(device(), &SerialDevice::deviceStateChanged, this, &ApplicationBackend::firmwareUpdateStateChanged);
...
void ApplicationBackend::registerMetaTypes()
{
    ...
    qRegisterMetaType<Flipper::Serial::DeviceInfo>("Flipper::Serial::DeviceInfo");
    qRegisterMetaType<Flipper::Serial::HardwareInfo>("Flipper::Serial::HardwareInfo");
    qRegisterMetaType<Flipper::Serial::SoftwareInfo>("Flipper::Serial::SoftwareInfo");
    qRegisterMetaType<Flipper::Serial::StorageInfo>("Flipper::Serial::StorageInfo");

    qRegisterMetaType<Flipper::SerialDevice*>("Flipper::SerialDevice*");
    qRegisterMetaType<Flipper::Serial::DeviceState*>("Flipper::Serial::DeviceState*");
    qRegisterMetaType<Flipper::Serial::ScreenStreamer*>("Flipper::Serial::ScreenStreamer*");
    qRegisterMetaType<Flipper::Serial::VirtualDisplay*>("Flipper::Serial::VirtualDisplay*");
    qRegisterMetaType<Flipper::Serial::FileManager*>("Flipper::Serial::FileManager*");
    qRegisterMetaType<Flipper::Serial::ScreenStreamer*>("Flipper::Serial::ScreenStreamer*");

    qRegisterMetaType<Flipper::Serial::AssetManifest::FileInfo>();
...
{
    QMetaType::registerComparators<Flipper::Serial::AssetManifest::FileInfo>();
}
#endif
