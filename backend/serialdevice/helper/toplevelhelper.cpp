...
AbstractTopLevelHelper::AbstractTopLevelHelper(UpdateRegistry *updateRegistry, SerialDevice *device, QObject *parent):
    ...
    m_device(device)
{
    ...
    connect(m_device, &SerialDevice::operationFinished, this, &AbstractTopLevelHelper::finish);
}
...
SerialDevice *AbstractTopLevelHelper::device()
{
    return m_device;
}
...
UpdateTopLevelHelper::UpdateTopLevelHelper(UpdateRegistry *updateRegistry, SerialDevice *device, QObject *parent):
...
RepairTopLevelHelper::RepairTopLevelHelper(UpdateRegistry *updateRegistry, SerialDevice *device, QObject *parent):
    AbstractTopLevelHelper(updateRegistry, device, parent)
{}
