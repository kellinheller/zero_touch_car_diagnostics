...
struct DeviceInfo {
    ...
    Q_PROPERTY(Flipper::Serial::HardwareInfo hardware MEMBER hardware)
    Q_PROPERTY(Flipper::Serial::SoftwareInfo firmware MEMBER firmware)
    Q_PROPERTY(Flipper::Serial::StorageInfo storage MEMBER storage)
...
Q_DECLARE_METATYPE(Flipper::Serial::HardwareInfo)
Q_DECLARE_METATYPE(Flipper::Serial::SoftwareInfo)
Q_DECLARE_METATYPE(Flipper::Serial::DeviceInfo)
Q_DECLARE_METATYPE(Flipper::Serial::StorageInfo)
